...
rem set "SDKBINDIR=C:\Program Files (x86)\Steam\steamapps\common\Alien Swarm\bin"
rem set "SDKBINDIR=C:\PROGRA~2\Steam\steamapps\common\ALIENS~1\bin"
set "SDKBINDIR=..\..\steam_path\bin"
...
@REM %BUILD_SHADER% stdshader_dx9_20b		-game %GAMEDIR% -source %SOURCEDIR% %dynamic_shaders%
